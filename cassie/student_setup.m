...
function [ctrl, student_data] = student_setup(x0, model)
    ...
    student_data.id = 3038661017 ; % ENTER YOUR STUDENT ID
    ...
    student_data.team_name = 'Groot' ; % ENTER YOUR TEAM NAME
    ...
    ctrl.ode_options = odeset('Events', @falldetect, 'AbsTol',1e-2, 'RelTol',1e-2); % abstol
end
